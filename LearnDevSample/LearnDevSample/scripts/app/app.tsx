...
var profile = ReactDOM.render(<Profile.DevLearnProfile defaultCourses={10} defaultArticles={13} />, document.getElementById("profileNode"));
...
ReactDOM.render(<Friends.Friends initialData={friendsData} />, document.getElementById('friendsNode'));
